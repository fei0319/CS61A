...
class TutorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        for _ in range(3): opponent.draw()
...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        "*** YOUR CODE HERE ***"
        for card in player.deck.cards: card.attack, card.defense = card.attack + other_card.attack, card.defense + other_card.defense
        opponent.deck.cards = [_ for _ in opponent.deck.cards if _.attack != other_card.attack and _.defense != other_card.defense]
